create database F28_hw_13

use F28_hw_13

create table Employees (EMPLOYEE_ID int, FIRST_NAME varchar(50),
LAST_NAME varchar(50),EMAIL varchar(255), PHONE_NUMBER varchar(50),HIRE_DATE date,JOB_ID varchar(50),
...
SELECT CONCAT(EMPLOYEE_ID, '-', first_name, ' ', last_name) AS all_info
FROM employees
...
SELECT *
FROM Employees
WHERE LEN(CONCAT(FirstName, LastName)) - LEN(REPLACE(CONCAT(FirstName, LastName), 'a', '')) >= 3;
